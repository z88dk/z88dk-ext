 ...
 /*
  * Recovered from the DECUS-C tape dumps
  *
  * zcc +cpm -create-app -lndos -O3 --opt-code-size ttt.c
  * zcc +cpm -create-app -lndos -SO3 --max-allocs-per-node400000 -compiler=sdcc ttt.c
  *
  */ 
  ...
  * I stole it out of Kilobaud, April 78.
