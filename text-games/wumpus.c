...
static char inp[160];        /* common input buffer */
...
void print_instructions() {
    ...
    "leading to other rooms. (look at a dodecahedron to see how this\n"
    "works.  If you don't know what a dodecahedron is, ask someone)\n");
    puts("     HAZARDS:\n"
    " Bottomless Pits - Two rooms have bottomless pits in them.\n"
    "     If you go there, you fall into the pit (& lose!)\n"
    " Super Bats - Two other rooms have super bats. If you go there\n"
    ...
    " wake him up: you shooting an arrow or you entering his room.\n"
    " If the wumpus wakes he moves (P=.75) one room or stays still\n"
    " (P=.25). After that, if he is where you are he eats you up\n"
	" and you lose!\n");
    (void) getlet("Press RETURN ");
    puts("     YOU:\n"
    ...
    "           to go to.  If the arrow can't go that way (if no \n"
    "           tunnel) it moves at random to the next room.\n"
    "           If the arrow hits the wumpus, you win.  If the arrow\n"
	"           hits you, you lose.\n\n"
    "     WARNINGS:\n"
